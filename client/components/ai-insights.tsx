...
export function AIInsights() {
  ...
  if (!mounted) {
    return (
      <div className="relative group h-[400px]">
        ...
        <div className="relative backdrop-blur-xl bg-gray-900/10 border border-purple-500/15 rounded-2xl p-6 h-full">
  ...
  return (
    <div className="backdrop-blur-xl bg-gray-900/10 border border-purple-500/15 rounded-2xl p-6 hover:border-purple-400/50 transition-all duration-300 shadow-xl hover:shadow-purple-500/10 hover:shadow-2xl h-[400px]">
