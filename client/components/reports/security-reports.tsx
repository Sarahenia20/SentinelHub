        ...
        <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-6">
          ...
          <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 transition-all duration-300 ${
            ...
            <div className="bg-black/20 border border-cyan-500/20 rounded-xl p-4 backdrop-blur-sm">
              <div className="text-sm text-cyan-400 mb-2">Critical Issues</div>
              <div className="text-2xl font-bold text-cyan-400">{totalVulnerabilities.critical + totalVulnerabilities.high}</div>
            ...
            <div className="bg-black/20 border border-green-500/20 rounded-xl p-4 backdrop-blur-sm">
              <div className="text-sm text-green-400 mb-2">Reports Saved</div>
              <div className="text-2xl font-bold text-green-400">{allSessions.length}</div>
              <div className="text-xs text-gray-400">Security reports</div>
            </div>
            
            <div className="bg-black/20 border border-blue-500/20 rounded-xl p-4 backdrop-blur-sm">
              <div className="text-sm text-blue-400 mb-2">Email Reports</div>
              <div className="text-2xl font-bold text-blue-400">{allSessions.filter(s => s.emailSent).length}</div>
              <div className="text-xs text-gray-400">Reports emailed</div>
            </div>
            
            <div className="bg-black/20 border border-purple-500/20 rounded-xl p-4 backdrop-blur-sm">
              <div className="text-sm text-purple-400 mb-2">Avg Score</div>
